...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg,#242424 0%,#242424 100%)';
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="w-[85%] absolute left-1/2 bottom-[-1px] backface-hidden will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
              ...
              {showUserInfo && (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className="rounded-full overflow-hidden border border-white/10 flex-shrink-0 flex items-center justify-center"
